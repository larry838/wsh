package com.wsh.generator.controller;
...
import com.wsh.common.utils.security.PermissionUtils;
import com.wsh.generator.domain.GenTable;
import com.wsh.generator.domain.GenTableColumn;
import com.wsh.generator.service.IGenTableColumnService;
import com.wsh.generator.service.IGenTableService;
...
public class GenController extends BaseController
{
     ...
     */
    @RequiresPermissions("tool:gen:list")
    @SysLog(title = "代码生成", businessType = BusinessType.IMPORT)
    ...
    @SysLog(title = "代码生成", businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
    ...
    @SysLog(title = "代码生成", businessType = BusinessType.DELETE)
    @PostMapping("/remove")
    @ResponseBody
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"wsh.zip\"");
