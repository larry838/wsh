...
import com.wsh.sys.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService
{
     ...
     */
	@Override
    public List<SysMenu> selectAllMenusByUser(SysUser user)
    {
     ...
     */
    @Override
    public List<SysMenu> selectTopMenusByUser(SysUser user)
    {
        List<SysMenu> menus = new LinkedList<SysMenu>();
        // root管理员显示所有菜单信息
        if (user.isRoot())
        {
            menus = menuMapper.selectTopMenuAll();
        }else{
           menus = menuMapper.selectTopMenusByUserId(user.getUserId());
        }
        return menus;
    }
    ...
    public String checkMenuNameUnique(SysMenu menu)
    {
        ...
        {
            return SysConstants.MENU_NAME_NOT_UNIQUE;
        }
        return SysConstants.MENU_NAME_UNIQUE;
    }
    ...
    private List<Ztree> initZtree(List<SysMenu> menuList, List<String> roleMenuList, boolean permsFlag)
    {
        ...
        for (SysMenu menu : menuList)
        {
            ...
            if (isCheck)
            {
                ztree.setChecked(roleMenuList.contains(menu.getMenuId() + menu.getPermissionCode()));
            }
            ztrees.add(ztree);
        }
        return ztrees;
    ...
    private String transMenuName(SysMenu menu, boolean permsFlag)
    {
        ...
        if (permsFlag)
        {
            sb.append("<font color=\"#888\">&nbsp;&nbsp;&nbsp;" + menu.getPermissionCode() + "</font>");
        }
        return sb.toString();
    }
}
