package com.wsh.common.utils.security;
...
public class PasswordUtil {
    ...
    public static String encrypt(String password, String salt) throws Exception {
        return AesUtil.encrypt(Md5Util.MD5(salt + _SECURITY_KEY), password);
    }
    ...
    public static String decrypt(String encryptPassword, String salt) throws Exception {
        return AesUtil.decrypt(Md5Util.MD5(salt + _SECURITY_KEY), encryptPassword);
    }
}
